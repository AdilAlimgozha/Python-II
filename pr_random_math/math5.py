            ...
            for b in range(-X, X + 1):
                for c in range(-X, X + 1):
                    if a < b < c:
                        ...
                        if check_triangle_exists(dist_ab, dist_bc, dist_ca) and check_45(dist_ab, dist_bc, dist_ca):
                            #print(k,"       ", a, b, c, end = "           ")
                            #print(dist_ab, dist_bc, dist_ca)
                            ctr += 1
                                    
    print(ctr)

number_of_triangles(1, 10)
