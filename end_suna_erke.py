...
import numpy as np
from mathematical_part_svd import *
...
class Make_matrix:
    def create_w(self):
        ...
        self.L = Label(self.window, text = 'Construct your matrix', bg = "cyan", font = ("slant", 15))
...
class Solution:
    def create_w(self):
        ...
        self.window.geometry('1500x765+200+40')
        ...
        self.L9 = Label(self.window, text = svd.C(), bg='greenyellow')
        ...
        self.L10 = Label(self.window, text = svd.B(), bg='greenyellow')
        ...
        self.L11 = Label(self.window, text = make_matrix.npA, bg='greenyellow')
        ...
        self.L12 = Label(self.window, text = svd.B(), bg='greenyellow')
        self.L12.place(x = 150, y = 600)
        self.L1212 = Label(self.window, text = "=", bg='greenyellow')
        self.L1212.place(x = 110, y = 615)

        self.L13 = Label(self.window, text = svd.D(), bg='greenyellow')
        self.L13.place(x = 460, y = 600)
        self.L1313 = Label(self.window, text = "*", bg='greenyellow')
        self.L1313.place(x = 445, y = 620)

        self.L13 = Label(self.window, text = svd.C(), bg='greenyellow')
        self.L13.place(x = 670, y = 600)
        self.L1313 = Label(self.window, text = "*", bg='greenyellow')
        self.L1313.place(x = 655, y = 620)
        self.button()
